...
const lodash_object = require('lodash/object');
const get = lodash_object.get;
const set = lodash_object.set;
...
// context.
export default function withAuthUser(ComposedComponent: ComponentType) {
